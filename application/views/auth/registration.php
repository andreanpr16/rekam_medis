                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" action="<?= base_url('auth/registration'); ?>" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="asal" name="asal" placeholder="Kota Asal Anda" value="<?= set_value('asal'); ?>">
                                <?= form_error('asal', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="no_telp" name="no_telp" placeholder="Nomor Telp/Hp" value="<?= set_value('no_telp'); ?>">
